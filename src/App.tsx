...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-primary/30 selection:text-primary relative overflow-hidden flex flex-col">
      ...
      <div className="hidden md:block absolute inset-0 bg-carbon opacity-10 pointer-events-none"></div>

      {/* Glow Effects - Hidden on mobile */}
      <div className="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] pointer-events-none opacity-20"></div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-4xl flex flex-col flex-grow">
        ...
        {/* Main Interface */}
        <main className="flex-1 flex flex-col gap-4 md:gap-6 justify-center">

          {/* Input Section */}
          <div className="group relative">
            {/* Gradient border - Hidden on mobile */}
            <div className="hidden md:block absolute -inset-0.5 bg-gradient-to-r from-primary/50 to-purple-600/50 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
            <div className="relative bg-[#050505] border border-white/10 rounded-2xl p-4 md:p-6 shadow-xl md:shadow-2xl">
              ...
              <textarea
                ...
                className="w-full h-28 md:h-32 bg-black/50 border border-white/5 rounded-xl p-3 md:p-4 text-base md:text-lg font-mono text-white placeholder-white/20 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all resize-none"
                spellCheck={false}
                dir="ltr"
              />
          ...
          <div className="flex justify-center my-1 md:my-2">
            <div className="bg-white/5 border border-white/10 rounded-full p-2 text-dim shadow-[0_0_15px_rgba(59,130,246,0.2)]">
              <ArrowDown size={20} className="animate-bounce md:animate-bounce" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="group relative">
              {/* Gradient border - Hidden on mobile */}
              <div className="hidden md:block absolute -inset-0.5 bg-gradient-to-r from-blue-500/50 to-cyan-500/50 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
              <div className="relative bg-[#050505] border border-white/10 rounded-2xl p-4 md:p-6 shadow-xl md:shadow-2xl h-full flex flex-col">
                <div className="flex justify-between items-center mb-3 md:mb-4">
                ...
                <div className="w-full flex-grow bg-black/50 border border-white/5 rounded-xl p-3 md:p-4 text-lg md:text-xl font-sans text-white/90 overflow-auto leading-relaxed min-h-[100px] md:min-h-[120px]" dir="ltr">
                  {output.english ? (
                    output.english
                  ) : (
            ...
            <div className="group relative">
              {/* Gradient border - Hidden on mobile */}
              <div className="hidden md:block absolute -inset-0.5 bg-gradient-to-r from-emerald-500/50 to-green-500/50 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
              <div className="relative bg-[#050505] border border-white/10 rounded-2xl p-4 md:p-6 shadow-xl md:shadow-2xl h-full flex flex-col">
                <div className="flex justify-between items-center mb-3 md:mb-4">
                ...
                <div className="w-full flex-grow bg-black/50 border border-white/5 rounded-xl p-3 md:p-4 text-lg md:text-xl font-sans text-white/90 overflow-auto leading-relaxed min-h-[100px] md:min-h-[120px]" dir="rtl">
                  {output.arabic ? (
                    output.arabic
                  ) : (
                    <span className="text-white/20 italic text-base">بانتظار الإشارة...</span>
        ...
        {/* Footer */}
        <footer className="mt-8 md:mt-12 py-4 md:py-6 border-t border-white/5 text-center">
          <p className="text-[10px] text-dim font-mono uppercase tracking-[0.2em] md:tracking-[0.3em]">
